...
let function meanOfArray(array: Array<string>)
    let count = #array
	var idx = 1
	...
	while idx<=count do
		sum = safemath.number_add(safemath.safenumber(array[idx]),sum)
		idx = idx+1
	end
...
let function calculatePrice(feedPrices: Array<string>)
    ...
    let result1 = meanOfArray(feedPrices)
    return result1
end
